...
openssl req -new -nodes -key ${CERTS_PRIV_PATH}/serverkey.pem -out ${CERTS_PRIV_PATH}/servercert.csr -subj /C=VN/ST="Binh Duong"/L="Thu Dau Mot"/O="VGU"/OU="REC"/CN="tunglevo.com"
